...
# Import model class
### THAY ĐỔI 2 ###
from models import HybridModel, quantum_circuit # Import model hybrid và qnode
...
from utils import (
    ...
    plot_decision_boundary, plot_quantum_circuit # Thêm plot_quantum_circuit
)

def main():
    # --- 1. SETUP & CONFIGURATION ---
    timestamp = time.strftime("%Y%m%d-%H%M%S")
    experiment_name = f"Moon_HQNN_{timestamp}" # Đổi tên
    ...
    ### THAY ĐỔI 4 ###
    model = HybridModel().to(DEVICE) # Sử dụng HybridModel
    ...
    # --- 5. TRAINING LOOP (Không thay đổi) ---
    ...
    # (Không thay đổi)
    model_save_path = os.path.join(final_result_dir, "hybrid_model.pth")
