...
def get_mnist_data_loaders():
    ...
    IMG_SIZE = TRAINING_CONFIG['img_size'] # Will be 28

    ### MODIFIED ### (Standard normalization values for MNIST, 1-channel)
    MNIST_MEAN = (0.1307,)
    MNIST_STD = (0.3081,)

    # --- 1. Define Preprocessing Transformations ---
    ### MODIFIED ### (Simpler transforms for MNIST, removed color augmentation)
    ...
    # --- 2. Load Datasets ---
    ### MODIFIED ### (Load MNIST instead of CIFAR10)
