...
from data_loader import get_cifar10_data_loaders # CORRECTED: Import CIFAR-10 loader
...
def main():
    ...
    experiment_name = f"HQNN_CIFAR10_{timestamp}" # Changed name for clarity
    ...
    # --- 2. DATA PREPARATION ---
    train_loader, test_loader = get_cifar10_data_loaders() # CORRECTED: Call CIFAR-10 loader
    ...
    for epoch in range(NUM_EPOCHS):
        if hasattr(model, 'quantum_layer'): # Check if the model has a quantum layer
