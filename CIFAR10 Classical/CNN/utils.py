...
from config import (
    ...
    IMG_HEIGHT, NUM_COLOR_CHANNELS
)

# --- 1. Directory and Logging Utilities ---

def setup_results_directory(experiment_name="cnn_cifar10_experiment"):
    """
...
def plot_training_metrics(train_loss, train_acc, test_loss, test_acc, filename=TRAINING_METRICS_PLOT_PATH):
    ...
    plt.suptitle(f"Model: CNN (CIFAR-10), Epochs: {num_epochs}, LR: {TRAINING_CONFIG['learning_rate']}", y=1.05)
    plt.tight_layout()
